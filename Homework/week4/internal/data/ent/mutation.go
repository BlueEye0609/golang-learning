...
func (m *StorageMutation) SetHostname(s string) {
	m.hostname = &s
}

// Hostname returns the value of the "hostname" field in the mutation.
func (m *StorageMutation) Hostname() (r string, exists bool) {
	v := m.hostname
	if v == nil {
		return
	}
...
// OldHostname returns the old "hostname" field's value of the Storage entity.
// If the Storage object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *StorageMutation) OldHostname(ctx context.Context) (v string, err error) {
...
func (m *StorageMutation) ResetHostname() {
	m.hostname = nil
}

// SetSize sets the "size" field.
func (m *StorageMutation) SetSize(i int) {
	m.size = &i
	m.addsize = nil
}

// Size returns the value of the "size" field in the mutation.
func (m *StorageMutation) Size() (r int, exists bool) {
	v := m.size
	if v == nil {
		return
	}
...
// If the Storage object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *StorageMutation) OldSize(ctx context.Context) (v int, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *StorageMutation) AddSize(i int) {
	if m.addsize != nil {
		*m.addsize += i
	} else {
		m.addsize = &i
...
func (m *StorageMutation) AddedSize() (r int, exists bool) {
	v := m.addsize
	if v == nil {
		return
	}
...
func (m *StorageMutation) Fields() []string {
	...
	if m.hostname != nil {
		fields = append(fields, storage.FieldHostname)
	}
	if m.size != nil {
