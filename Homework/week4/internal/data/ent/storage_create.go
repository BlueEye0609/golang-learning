...
func (sc *StorageCreate) SetHostname(s string) *StorageCreate {
	sc.mutation.SetHostname(s)
	return sc
}

// SetSize sets the "size" field.
func (sc *StorageCreate) SetSize(i int) *StorageCreate {
...
func (sc *StorageCreate) check() error {
	if _, ok := sc.mutation.Hostname(); !ok {
		return &ValidationError{Name: "hostname", err: errors.New(`ent: missing required field "Storage.hostname"`)}
	}
